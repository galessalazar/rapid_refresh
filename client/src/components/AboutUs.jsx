...
function AboutUs() {
  return (
    <section className="about-us">
      ...
      <h2>Our Services</h2>
      <ul>
        <li>Residential Cleaning: Homes, apartments, and condos.</li>
        <li>Commercial Cleaning: Offices, reatil spaces, and business locations.</li>
        <li>Move-in/Move-out Cleaning: Make your transition easy with a thorough clean.</li>
        <li>Deep Cleaning: A detailed, one-time service to get every nook and cranny.</li>
